...
class Model(BaseModel):
    ...
    soft_substrates: str | bool = Field(
        ..., validation_alias=AliasChoices("Soft_Substrates", "soft_substrates")
    )
    hard_substrates: str | bool = Field(
        ..., validation_alias=AliasChoices("Hard_Substrates", "hard_substrates")
    )
    ...
    contact_person: str = Field(
        ..., validation_alias=AliasChoices("contect person", "contact_person")
    )
