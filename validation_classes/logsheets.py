...
class Model(BaseModel):
    ...
    institute: str = Field(..., validation_alias=AliasChoices("EMBRC Site", "institute"))
    observatory_id: str = Field(..., validation_alias=AliasChoices("EMOBON_observatory_id", "observatory_id"))
    water_column: HttpUrl | None = Field(..., validation_alias=AliasChoices("Water Column", "water_column"))
    soft_sediment: HttpUrl | None = Field(..., validation_alias=AliasChoices("Soft sediment", "soft_sediemnt"))
