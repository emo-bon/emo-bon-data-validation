...
class Model(BaseModel):
    ...
    sea_subsurf_temp_method: str | None = None # Not taken for soft sediments
    sea_surf_salinity: float | str | None = None # Not taken for soft sediments
    sea_surf_salinity_method: str | None = None # Not taken for soft sediments
    sea_subsurf_salinity: float | str | None = None # Not taken for soft sediments
    sea_subsurf_salinity_method: str | None = None # Not taken for soft sediments
    alkalinity: str | None
    ...
    @field_validator("chlorophyll", "sea_surf_salinity",
                     "sea_subsurf_salinity", "phosphate",
                     "pigments", "diss_oxygen", "pressure",
                    "density")
    @classmethod
    ...
    @classmethod
    def coerce_str_float_with_comma_to_float(cls, value: float | str | None) -> float | None:
        if not value:
            return None
        if isinstance(value, float):
            return value
    ...
    @classmethod
    def coerce_string_float_with_comma_to_float(cls, value: float | str | None) -> float | None:
